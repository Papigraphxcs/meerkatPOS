...
export function useKeyboardShortcuts() {
    ...
    const shortcuts: Shortcut[] = [
        ...
        },
        {
            ...
            category: "POS",
            global: true,
            action: () => { window.dispatchEvent(new CustomEvent("xpos:toggle-view")); },
        },
        {
            id: "select-customer",
            keys: ["f6"],
            ...
            category: "POS",
            global: true,
            action: () => { window.dispatchEvent(new CustomEvent("xpos:select-customer")); },
        },
        {
            id: "held-invoices",
            keys: ["f8"],
        ...
        },
        {
            ...
            category: "POS",
            action: () => { window.dispatchEvent(new CustomEvent("xpos:focus-discount")); },
        },
        {
            id: "hold-invoice",
            keys: ["ctrl", "h"],
        ...
        },
        {
            ...
            category: "Cart",
            action: () => { window.dispatchEvent(new CustomEvent("xpos:remove-last-item")); },
        },
        {
            id: "close-shift",
            keys: ["ctrl", "shift", "o"],

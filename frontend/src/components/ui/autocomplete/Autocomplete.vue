    ...
    <PopoverRoot v-model:open="open">
      <PopoverAnchor as-child>
        <div class="relative">
          ...
          <input v-model="query" type="text" autocomplete="new-password"
      ...
      <PopoverPortal>
        <PopoverContent align="start" side="bottom" :side-offset="4"
          ...
          <div v-if="loading && filteredOptions.length === 0"
          ...
          <template v-else>
            <template v-for="(groupOptions, groupName) in groupedOptions.groups" :key="groupName">
              ...
              <button v-for="option in groupOptions" :key="option.value"
                :data-autocomplete-index="flatVisibleOptions.indexOf(option)" type="button" :disabled="option.disabled"
                ...
                <div class="flex-1 min-w-0">
                  ...
                  <div v-if="option.description" class="text-xs text-muted-foreground truncate mt-0.5">
                    {{ option.description }}
                  </div>
                </div>
          ...
          <div v-else-if="query && matchCount > 0 && matchCount <= maxVisible"

                ...
                <div class="space-y-6 pr-4">
                    <div>
                        ...
                        <div class="space-y-1.5">
                            <ShortcutItem :shortcut="['Ctrl', 'N']" :description="__('New Sale / Clear Cart')" />
                            <ShortcutItem :shortcut="['Ctrl', 'K']" :description="__('Open Command Search')" />
                            <ShortcutItem :shortcut="['Ctrl', '/']" :description="__('Show Keyboard Shortcuts')" />
                    ...
                    <div>
                        ...
                        <div class="space-y-1.5">
                            ...
                            <ShortcutItem :shortcut="['Alt', '3']" :description="__('Go to Purchase Order')" />
                            <ShortcutItem :shortcut="['Alt', '4']" :description="__('Go to Purchase Invoice')" />
                            <ShortcutItem :shortcut="['Alt', '5']" :description="__('Go to Stock Receiving')" />
                    ...
                    <div>
                        ...
                        <div class="space-y-1.5">
                            ...
                            <ShortcutItem :shortcut="['F5']" :description="__('Toggle Item View (Grid/List)')" />
                            <ShortcutItem :shortcut="['F6']" :description="__('Select Customer')" />
                            <ShortcutItem :shortcut="['F8']" :description="__('Toggle Held/Draft Invoices')" />
                            <ShortcutItem :shortcut="['Ctrl', 'G']" :description="__('Repeat Last Invoice')" />
                            ...
                            <ShortcutItem :shortcut="['Ctrl', 'H']" :description="__('Hold / Park Invoice')" />
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="space-y-1.5">
                            ...
                            <ShortcutItem :shortcut="['Enter']" :description="__('Add Selected Item to Cart')" />
                    ...
                    <div>
                        ...
                        <div class="space-y-1.5">
                            <ShortcutItem :shortcut="['Delete']" :description="__('Remove Last Item from Cart')" />
                            <ShortcutItem :shortcut="['Ctrl', 'Delete']" :description="__('Clear All Items from Cart')" />
                            <ShortcutItem :shortcut="['+', '-']" :description="__('Increase/Decrease Quantity (in cart)')" />
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="space-y-1.5">
                            <ShortcutItem :shortcut="['Ctrl', 'Shift', 'O']" :description="__('Close Shift')" />
                            <ShortcutItem :shortcut="['Ctrl', 'E']" :description="__('Cash Expense')" />
                            <ShortcutItem :shortcut="['Ctrl', 'Shift', 'D']" :description="__('Cash Deposit')" />
                        </div>
                    </div>
                    ...
                    <div v-if="isElectronEnv">
                        ...
                        <div class="space-y-1.5">
                            <ShortcutItem :shortcut="['Ctrl', 'Shift', 'S']" :description="__('Trigger Manual Sync')" />
                        </div>
                    </div>
                </div>
            </ScrollArea>
...
import {
    Keyboard, Monitor, Navigation, ShoppingCart, Package, List, Clock, RefreshCw

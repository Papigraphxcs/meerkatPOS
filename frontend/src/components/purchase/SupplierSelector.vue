            ...
            <div v-else class="divide-y divide-border">
                <button v-for="supplier in purchaseStore.suppliers" :key="supplier.name"
                    ...
                    <div class="flex-1 min-w-0">
                        ...
                        <p class="text-sm text-muted-foreground truncate">{{ supplier.supplier_group || supplier.name }}
                        </p>
                    </div>
                </button>
            </div>
        ...
        <div v-if="purchaseStore.selectedSupplier" class="p-4 border-t border-border bg-primary/10">
            <div class="flex items-center justify-between">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <p class="font-medium">{{ purchaseStore.selectedSupplier.supplier_name }}</p>
                        <p class="text-sm text-muted-foreground">{{ purchaseStore.selectedSupplier.name }}</p>
                    </div>
                </div>

...
from xpos.x_pos.api.cash_movement import queries, service, validation
...
class TestCashMovementService(unittest.TestCase):
    @patch("xpos.x_pos.api.cash_movement.service.parse_payload")
    @patch("xpos.x_pos.api.cash_movement.service.get_opening_shift")
    @patch("xpos.x_pos.api.cash_movement.service.get_pos_profile")
    @patch("xpos.x_pos.api.cash_movement.service.validate_company_consistency")
    @patch("xpos.x_pos.api.cash_movement.service.ensure_feature_enabled")
    @patch("xpos.x_pos.api.cash_movement.service.ensure_movement_allowed")
    @patch("xpos.x_pos.api.cash_movement.service.validate_amount")
    @patch("xpos.x_pos.api.cash_movement.service.validate_remarks")
    @patch("xpos.x_pos.api.cash_movement.service.ensure_no_duplicate_client_request")
    @patch("xpos.x_pos.api.cash_movement.service.resolve_source_cash_account")
    @patch("xpos.x_pos.api.cash_movement.service.resolve_target_account")
    @patch("xpos.x_pos.api.cash_movement.service.validate_account_company")
    @patch("xpos.x_pos.api.cash_movement.service.create_journal_entry")
    @patch("xpos.x_pos.api.cash_movement.service.frappe")
    ...
    @patch("xpos.x_pos.api.cash_movement.service._create_cash_movement")
    @patch("xpos.x_pos.api.cash_movement.service.ensure_owner_or_manager")
    @patch("xpos.x_pos.api.cash_movement.service.frappe")
